# azurelocal-vm-conversion-toolkit — Agent instructions
...
```
bootstrap(repo="azurelocal-vm-conversion-toolkit", client="<your client: claude-code | codex | gemini | cursor | vscode>")
```
